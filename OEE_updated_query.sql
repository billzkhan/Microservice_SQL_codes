 <select id="inquiryItvOee" resultType="com.dpworld.zodiac.manager.model.mybatis.OverallEquipmentEffectivenessDto">
        WITH day_cond AS
    ...
    <select id="inquiryCraneOee" resultType="com.dpworld.zodiac.manager.model.mybatis.OverallEquipmentEffectivenessDto">
        WITH day_cond AS
            (SELECT #{dDay}::TIMESTAMP start_time,
                    #{dDay}::TIMESTAMP + INTERVAL '1 day' - INTERVAL '1 ms' end_time)
        SELECT m.calendar_time_min,
